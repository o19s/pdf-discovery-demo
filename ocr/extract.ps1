...
if(![System.IO.File]::Exists($extract_file_json)){
  ...
  $result = java -cp tika-app-1.23-SNAPSHOT.jar org.apache.tika.cli.TikaCLI --config=default-tika-config.xml --xmp --jsonRecursive --extract --pretty-print -x $pdf_file
