...
$(document).ready(function () {
  ...
  $('form input[type="text"]')[0].value = query;

  $.getJSON('http://165.22.182.252:8983/solr/documents/select?q=' + query + '&fl=id,content,path,page_dimensions&hl=on&hl.snippets=10&hl.fl=content&indent=on&wt=json&pl=on&echoParams=all', function(data) {
