...
$(document).ready(function () {
  ...
  $.getJSON('//' + window.location.hostname + ':8983/solr/documents/select?q={!parent which="content_type:parentDocument"}' + query + '&fl=id,content_type,content,path,[child parentFilter=content_type:parentDocument limit=1]', function(data) {
